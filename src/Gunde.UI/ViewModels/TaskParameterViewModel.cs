...
using Gunde.UI.Exceptions;
using Gunde.UI.Mvvm;

namespace Gunde.UI.ViewModels
{
    internal class TaskParameterViewModel : ViewModelBase
    {
        private readonly ParameterInfo _parameterInfo;

        public TaskParameterViewModel(ParameterInfo parameterInfo)
        {
        ...
        public object TypedValue
        {
            get
            {
                ...
                {
                    throw new GundeConversionException($"Could not convert value '{Value}' to type '{_parameterInfo.ParameterType}' needed for parameter '{_parameterInfo.Name}'");
                }
            }
        }
